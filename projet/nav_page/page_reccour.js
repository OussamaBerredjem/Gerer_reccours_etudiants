...
var request = new XMLHttpRequest();
          request.open("GET", "http://localhost/test/php/requests.php?reccours", true);
                           ...
                           var responseData = JSON.parse(request.responseText);
                            ...
                            responseData.forEach(function (student) {
                              ...
                              var acceptButton = clone.querySelector('.accept-button');
                                ...
                                req.open("GET","http://localhost/test/php/requests.php?accept="+student['id'],true);
                                req.send();
                                ...
                                var req = new XMLHttpRequest();
                                req.open("GET","http://localhost/test/php/requests.php?desline="+student['id'],true);
                                req.send();
